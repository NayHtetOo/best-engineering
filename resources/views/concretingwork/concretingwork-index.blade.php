...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="text-end">
                <button class="btn btn-outline-primary px-2 py-1 mb-3">Create Concreting Work</button>
            </div>
                ...
                <table class="table table-hover table-bordered">
                    <thead>
                        <tr style="background: #e4f7eb;">
                            ...
                            <th style="font-weight: bold;background:blue;color:white;text-align: center;">Mixed Type</th>
                            ...
                            <th style="font-weight: bold;background:blue;color:white;min-width: 100px;text-align: center;">Machine Drivers</th>

                            <th style="font-weight: bold;background:blue;color:white;text-align: center;min-width:150px;">Action</th>
                        </tr>
                    </thead>
                    <tbody>
                        @foreach ($concreting_works as $data)
